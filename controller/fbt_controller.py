...
class FBTController(BaseController):
    ...
    async def check_plp_url(self, browser: BrowserContext):
        try:
            ...
            if product_listing_page_url.startswith("https://www.homedepot.com/s/glacier%20bay%20vanity%20mirrors"):
    ...
    async def check_product_info_page_url(self, browser: BrowserContext):
        try:
            ...
            if product_information_page_url.startswith("https://www.homedepot.com/p/Glacier-Bay-36-in-x-60-in-Classic-Rectangular-Frameless-Wall-Bathroom-Vanity-Mirror-GB-36X60-P/318270882"):
